         ...
         <FormGroup controlId="formControlsSelect">
          <Col style={{color:'black'}} componentClass={ControlLabel} sm={4}>
           <ControlLabel>Category</ControlLabel>
            ...
            <Col sm={8}>
           <FormControl style={{color:'black'}} componentClass="select" bsSize="small" placeholder="category" value={this.state.category}  onChange={this.setValue.bind(this, 'category')} required>
         ...
         <FormGroup controlId="formControlsSelect">
          <Col style={{color:'black'}} componentClass={ControlLabel} sm={4}>
           <ControlLabel>Sub Category</ControlLabel>
            ...
            <Col sm={8}>
           <FormControl style={{color:'black'}} componentClass="select" placeholder="subCategory" bsSize="small" value={this.state.subCategory}  onChange={this.setValue.bind(this, 'subCategory')} required>
             <option value="">select</option>
